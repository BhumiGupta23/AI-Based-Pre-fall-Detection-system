...
FEATURES:- Real-time fall detection using computer vision
           ...
           Dashboard for monitoring fall events
           Privacy protection using blurred image storage
           Multi-frame validation to reduce false detections
## Technologies Used
Python, OpenCV, Flask, SQLite, HTML/CSS

## Workflow
Video Input → Detection → Alerts → Dashboard
